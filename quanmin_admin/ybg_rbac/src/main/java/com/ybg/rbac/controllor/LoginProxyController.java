...
public class LoginProxyController {
	...
	public static Loginproxy login(HttpServletRequest httpServletRequest, String loginname, String password, String redirurl)
		...
		AuthenticationManager authenticationManager = (AuthenticationManager) SpringContextUtils
