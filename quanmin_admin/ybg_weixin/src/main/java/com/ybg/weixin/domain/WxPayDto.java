...
public class WxPayDto implements Serializable {
	 ...
	 * 
	 */
	private static final long	serialVersionUID	= 7129580492503082617L;
	...
	public String toString() {
		return "WxPayDto [orderId=" + orderId + ", totalFee=" + totalFee + ", spbillCreateIp=" + spbillCreateIp + ", notifyUrl=" + notifyUrl + ", body=" + body + ", openId=" + openId + "]";
	}
