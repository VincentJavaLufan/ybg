...
public class PayorderDaoImpl extends BaseDao implements PayorderDao {
	...
	private static String	QUERY_TABLE_COLUMN	= "payorder.transactiontype, payorder.payid, 	  payorder.userid, 	  payorder.gmt_create, 	  payorder.gmt-modified, 	  payorder.subject, 	  payorder.body, 	  payorder.price, 	  payorder.outTradeno, 	  payorder.banktype, 	  payorder.deviceinfo, 	  payorder.spbillcreateip, 	  payorder.authcode, 	  payorder.wapurl, 	  payorder.wapname, 	  payorder.openid, id";
	...
	public PayorderVO save(PayorderVO payorder) throws Exception {
		...
		createmap.put("transactiontype", payorder.getTransactionype());
		createmap.put("payid", payorder.getPayid());
