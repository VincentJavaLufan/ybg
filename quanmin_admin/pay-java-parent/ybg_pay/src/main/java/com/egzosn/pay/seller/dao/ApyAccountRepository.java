...
//import com.egzosn.pay.demo.domain.ApyAccountDO;
//import com.egzosn.pay.demo.domain.PayType;
//
...
//    public static   Map<Integer, ApyAccountDO> apyAccounts = new HashMap<>();
//
//    /**
//     * 这里简单初始化，引入orm等框架之后可自行删除
//     */
//    {
//        ApyAccountDO apyAccount1 = new ApyAccountDO();
...
//
//        ApyAccountDO apyAccount2 = new ApyAccountDO();
...
//
//        ApyAccountDO apyAccount3 = new ApyAccountDO();
...
//     * @return
//     */
//    public ApyAccountDO findByPayId(Integer payId){
