...
public class SinaUserInfo {
	...
	String	name;				// 友好显示名称
	Integer	province;			// 用户所在省级ID
	Integer	city;				// 用户所在城市ID
	...
	Integer	followers_count;	// 粉丝数
	Integer	friends_count;		// 关注数
	Integer	statuses_count;		// 微博数
	Integer	favourites_count;	// 收藏数
	...
	String	avatar_large;		// 用户头像地址（大图），180×180像素
	String	avatar_hd;			// 用户头像地址（高清），高清头像原图
	String	verified_reason;	// 认证原因
	boolean	follow_me;			// 该用户是否关注当前登录用户，true：是，false：否
	Integer	online_status;		// 用户的在线状态，0：不在线、1：在线
