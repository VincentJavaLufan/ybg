...
public class MayunUserInfoVO {
	...
	public Integer getTotal_repos() {
		return total_repos;
	}
	
	public void setTotal_repos(Integer total_repos) {
		this.total_repos = total_repos;
	}
	
	public Integer getOwned_repos() {
		return owned_repos;
	}
	
	public void setOwned_repos(Integer owned_repos) {
