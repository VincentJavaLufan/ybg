...
public class RegionServiceProxy {
	 ...
	 * @throws Exception
	 */
	public List<RegionVO> listPriVince(RegionQuery qvo, UserVO user) throws Exception {
		// TODO 查询用户所在的省份。
	 ...
	 * @throws Exception
	 */
	public List<RegionVO> listCity(RegionQuery qvo, UserVO user) throws Exception {
		// TODO 查询用户所在的地市。
		return regionService.list(qvo);
	}
	 ...
	 * @throws Exception
	 */
	public List<RegionVO> listAgency(RegionQuery qvo, UserVO user) throws Exception {
		// TODO 查询用户所在的的区县逻辑
		return regionService.list(qvo);
	}
}
